...
# Count the number of rows/movies in the data set and the number of columns
df.shape

# Creating a list of imp. columns for the recommendation engine
columns = ['Actors', 'Director', 'Genre', 'Title']

# Show the data 
df[columns].head(3)

# Checking missing values in imp columns
